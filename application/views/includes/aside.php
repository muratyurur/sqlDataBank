        ...
        <div class="menubar-scroll-inner">
            <ul class="app-menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu" id="portfolio-submenu">
                        <li><a href="<?php echo base_url("users"); ?>"><span class="menu-text">TUZ-YAP</span></a></li>
                        <li><a href="<?php echo base_url("user-roles"); ?>"><span class="menu-text">Sosyal Yardım İşleri M.</span></a></li>
                        <li><a href="<?php echo base_url("user-roles"); ?>"><span class="menu-text">İnsan Kaynakları ve Eğitim M.</span></a></li>
                    </ul>
                </li>
